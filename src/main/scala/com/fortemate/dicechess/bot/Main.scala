...
object Main:
  ...
  private val MissingWebhookKeys   = "At least one webhook signing secret must be set and non-empty"
  private val MissingWebhookSecret = "DICECHESS_WEBHOOK_SECRET must be set and non-empty"
